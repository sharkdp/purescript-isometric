              ...
              return function (__copy_v2) {
                  return function (__copy_popped) {
                      ...
                      tco: while (true) {
                          ...
                          if (v2 instanceof Data_List.Cons && Prelude["=="](dictEq)(v(v1))(v(v2.value0))) {
                              return {
                                  path: v2.value1, 
                      ...
                      return Control_Monad_Eff.runPure(function __do() {
                          ...
                          var lowlinkOfKey = function (k) {
                              return function __do() {
                                  return Data_Map.lookup(dictOrd)(k)(v4.value);
                              };
                          };
                          ...
                          var indexOfKey = function (k) {
                              return function __do() {
                                  return Data_Map.lookup(dictOrd)(k)(v3.value);
                              };
                          };
...
(function(exports) {
  ...
  var transform = function (t) {
      var go = function (v) {
          ...
          throw new Error("Failed pattern match at Graphics.Isometric line 133, column 5 - line 134, column 5: " + [ v.constructor.name ]);
      };
      return go;
  };
  var translateX = function (dx) {
  ...
  var polygon = function (num) {
      return function (r) {
          return Prelude.bind(Prelude.bindArray)(Data_Array[".."](0)(num - 1))(function (v) {
              var phi = ((-2.0 * $$Math.pi) / Data_Int.toNumber(num)) * Data_Int.toNumber(v);
              return Prelude["return"](Prelude.applicativeArray)({
                  x: r * $$Math.cos(phi), 
                  y: r * $$Math.sin(phi)
              });
          });
  ...
  var move = function (v) {
      return Prelude.map(Prelude.functorArray)(Prelude.map(Prelude.functorArray)(Graphics_Isometric_Point.translate(v)));
  };
  ...
  var renderFace = function (dir) {
      return function (color) {
          return function (face) {
              var path = Graphics_Drawing.closed(Data_Foldable.foldableArray)(Prelude["<$>"](Prelude.functorArray)(project)(face));
  ...
  var renderScene = function (dir) {
      return function (scene) {
          ...
          var go = function (v) {
              ...
              throw new Error("Failed pattern match at Graphics.Isometric line 197, column 1 - line 198, column 1: " + [ v.constructor.name ]);
          };
          return go(scene);
      };
  };
  var extrudeCone = function (path2D) {
      return function (height) {
          ...
          var path = Prelude["<$>"](Prelude.functorArray)(Graphics_Isometric_Point.from2D)(path2D);
          var sides = Data_Array.zipWith(side)(path)(Data_Array.cons(Data_Array_Unsafe.last(path))(path));
          return Data_Array.cons(path)(sides);
      };
  };
  var extrude = function (path2D) {
      return function (height) {
          ...
          var side = function (p1) {
              return function (p2) {
                  return [ p1, p2, raise(p2), raise(p1) ];
              };
          };
          var path = Prelude["<$>"](Prelude.functorArray)(Graphics_Isometric_Point.from2D)(path2D);
          var sides = Data_Array.zipWith(side)(path)(Data_Array.cons(Data_Array_Unsafe.last(path))(path));
          var top = Prelude["<$>"](Prelude.functorArray)(raise)(path);
          return Prelude["<>"](Prelude.semigroupArray)([ path, Data_Array.reverse(top) ])(sides);
      };
  };
...
(function(exports) {
  ...
  var depthSort = function ($44) {
      return toScene(Data_Graph.topSort(eqVertex)(ordVertex)(toGraph($44)));
  };
...
(function(exports) {
  ...
  var Graphics_Drawing = PS["Graphics.Drawing"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];     
  var scene4 = function (phi) {
      var theta = $$Math.pi / 3.0;
      var pink$prime = Color.darken(0.2)(Color_Scheme_MaterialDesign.pink);
      var move = function ($4) {
      ...
      return Graphics_Drawing.translate(250.0)(200.0)(Graphics_Isometric.renderScene({
          ...
          y: ly, 
          z: lz
      })(Graphics_Isometric.scale(150.0)(Prelude["<>"](Graphics_Isometric.semigroupScene)(Graphics_Isometric.filled(pink$prime)(Graphics_Isometric.cone(Graphics_Isometric_Point.origin)(20)(1.0)(1.5)))(Prelude["<>"](Graphics_Isometric.semigroupScene)(move(Graphics_Isometric.filled(Color_Scheme_MaterialDesign.red)(Graphics_Isometric.cube(Graphics_Isometric_Point.origin)(0.4))))(Graphics_Isometric.filled(Color_Scheme_MaterialDesign.yellow)(Graphics_Isometric.cube({
          x: 1.4 * lx, 
          y: 1.4 * ly, 
          z: 1.4 * lz
      })(5.0e-2)))))));
  ...
  var scene2 = function (rotZ) {
      return function (time) {
          ...
          return Graphics_Drawing.translate(250.0)(200.0)(Graphics_Isometric.renderScene({
              ...
              y: -1.0, 
              z: 3.0
          })(Graphics_Isometric.scale(45.0)(Graphics_Isometric_DepthSort.depthSort(Graphics_Isometric.rotateZ(rotZ)(Prelude["<>"](Graphics_Isometric.semigroupScene)(Graphics_Isometric.filled(Color_Scheme_MaterialDesign.grey)(Graphics_Isometric.prism(Graphics_Isometric_Point.point(-3.5)(-3.5)(-0.5))(7.0)(7.0)(0.5)))(Prelude["<>"](Graphics_Isometric.semigroupScene)(Graphics_Isometric.filled(Color_Scheme_MaterialDesign.purple)(Graphics_Isometric.prism(Graphics_Isometric_Point.point(-1.0)(pos1)(0.0))(2.0)(1.0)(2.0)))(Graphics_Isometric.filled(Color_Scheme_MaterialDesign.red)(Graphics_Isometric.prism(Graphics_Isometric_Point.point(pos2)(-1.0)(0.0))(1.0)(2.0)(2.0)))))))));
      };
  };
      ...
      return function (offset) {
          ...
          return Graphics_Drawing.translate(250.0)(150.0)(Graphics_Isometric.renderScene({
              ...
              return Prelude.bind(Prelude.bindArray)(Data_Array[".."](0)(n))(function (v1) {
                  ...
                  return Prelude["return"](Prelude.applicativeArray)(Graphics_Isometric.filled(Color.hsl(300.0 * x)(0.5)(0.5))(Graphics_Isometric.prism(pos)(w)(w)(h)));
              });
          }))));
      };
  };
  ...
  var main = function __do() {
      ...
      return Flare_Drawing.runFlareDrawing("controls4")("canvas4")(Prelude["<$>"](Flare.functorUI)(scene4)(Prelude["*"](Flare.semiringUI(Prelude.semiringNumber))(Prelude.pure(Flare.applicativeUI)(1.5e-3))(Flare.lift(Signal_DOM.animationFrame))))();
  };
  exports["main"] = main;
